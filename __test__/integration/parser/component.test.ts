import Components from "../../../src/parser/component";
import { SmartAPIComponentObject } from "../../../src/parser/types"
const components = {
    "parameters": {
        "callback": {
...
describe('test fetch ref', () => {
    let cp_obj: SmartAPIComponentObject;
    beforeAll(() => {
        cp_obj = new Components(components);
    });
